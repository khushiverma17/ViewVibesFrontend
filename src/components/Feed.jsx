...
function Feed({sidebar, setSidebar}) {
  ...
  return (
    ...
    <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mt-4`}>
      <Link to={`/home`} className="flex flex-col">
        <img className="w-full h-56 object-cover rounded-lg" src={thumbnail} alt="Video Thumbnail" />
        <h2 className="text-lg font-semibold text-white mt-2">Title</h2>
        <h3 className="text-base font-semibold text-gray-600 mt-1">Owner</h3>
